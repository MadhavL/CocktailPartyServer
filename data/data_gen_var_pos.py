...
class SPRoomSimulator:
    ...
    def create_sample(self, 
        ...
        for interf_idx, interf_path in enumerate(speaker_list[1:]):
            ...
            meta["speaker_phis"] = speaker_phis
...
def prep_speaker_mix_data(store_dir: str,
    ...
    print(wsj0_path)
    print(os.path.join(wsj0_path, 'si_tr_s/*/*.wav'))
    ...
    test_samples = list(sorted(glob.glob(os.path.join(wsj0_path, 'si_dt_05/*/*.wav'))))
